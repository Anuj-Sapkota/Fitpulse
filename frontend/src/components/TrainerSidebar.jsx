...
const TrainerSidebar = ({ username }) => {
  ...
  const trainerLinks = [
    ...
    { to: '/trainer/dashboard/workouts', label: 'Workouts' },
    { to: '/trainer/dashboard/manage-clients', label: 'Manage Clients' },
    { to: '/trainer/dashboard/create-workouts', label: 'Create Workouts' },
    { to: '/trainer/dashboard/trainerProfile', label: 'Profile' },
  ];
